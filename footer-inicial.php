...
<div id="footer-falso-inicial"><!-- INÍCIO FOOTER FALSO INICIAL -->

<div id="rodape-inicial"><!-- INÍCIO RODAPÉ INIICAL -->
...
<div id="rodape-inicial-logo-calo-na-mao"><a id="a-rodape-inicial-logo-calo-na-mao" href="<?php echo home_url( '/' ); ?>projeto"></a></div>

</div><!-- FINAL RODAPÉ INIICAL -->

</div><!-- FINAL FOOTER FALSO INICIAL -->
